...
// channel and ID data
const char* myID = "Candide"; // place your name here, this will be put into your "sender" value for an outgoing messsage

char publishChannel[] = "ottawaCAN"; // channel to publish YOUR data
char readChannel[] = "nairobiKEN"; // channel to read THEIR data
